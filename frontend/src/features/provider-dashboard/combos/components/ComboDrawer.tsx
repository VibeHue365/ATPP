...
export const ComboDrawer: React.FC<ComboDrawerProps> = ({
  isOpen,
  onClose,
  editingComboId,
  cName,
  ...
  return (
    <>
      {/* 1. Backdrop Overlay */}
      <div className="cb-drawer-backdrop" onClick={onClose} />

      {/* 2. Slide-Over Drawer (620px) */}
      <div className="cb-drawer-container">
        {/* Drawer Header */}
        <div className="cb-drawer-header">
          <div className="cb-drawer-title-group">
            <div className="cb-drawer-icon-box">
              <Layers size={22} />
            </div>
            <div>
              ...
              <p className="cb-drawer-subtitle">
                Kết hợp Áo Dài và Gói Chụp Ảnh để mang đến trải nghiệm tiện lợi và hấp dẫn cho khách hàng
              </p>
            </div>
          </div>
          <button
        ...
        {/* Drawer Form Body */}
        <form onSubmit={onSubmit} className="cb-drawer-body">
          ...
          <div className="cb-form-section">
            <h4 className="cb-section-title">
              ...
              2. Chọn sản phẩm & dịch vụ ghép cặp
            </h4>
            ...
            <div className="cb-field-group">
              ...
              <div className="cb-picker-card">
                  ...
                  <div className="cb-picker-info">
                    ...
                    <div className="cb-picker-sub">
                      {selectedProduct ? (
                        ...
                        <span>Nhấn nút bên phải để chọn mẫu áo từ kho của bạn</span>
                      )}
                    </div>
                  </div>
                </div>
                ...
                >
                  {selectedProduct ? 'Thay đổi áo' : '+ Chọn áo dài'}
                </button>
              </div>
            </div>
            ...
            <div className="cb-field-group">
              ...
              <div className="cb-picker-card">
                  ...
                  <div className="cb-picker-info">
                    ...
                    <div className="cb-picker-sub">
                      {selectedPackage ? (
                        <>
                          ...
                          {selectedPackage.durationHours && (
                            <span style={{ background: '#F3ECE1', padding: '1px 6px', borderRadius: 4, fontWeight: 600 }}>
                              {selectedPackage.durationHours}h chụp
                            </span>
                          )}
                        ...
                        <span>Nhấn nút bên phải để chọn gói dịch vụ chụp ảnh</span>
                      )}
                    </div>
                  </div>
                </div>
                ...
                >
                  {selectedPackage ? 'Thay đổi gói' : '+ Chọn gói chụp'}
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="cb-form-section">
            ...
            <div className="cb-grid-2cols">
              <div className="cb-field-group">
                <label className="cb-field-label">
                  Phần trăm chiết khấu (%) <span style={{ color: '#E11D48' }}>*</span>
                </label>
                ...
                <span className="cb-field-hint">Khuyến nghị từ 5% - 50%</span>
              </div>

              <div className="cb-field-group">
                <label className="cb-field-label">Giá combo tự định nghĩa (đ)</label>
                <div className="cb-input-with-suffix">
                  <input
                    type="number"
                    min="0"
                ...
                <span className="cb-field-hint">Ghi đè giá nếu muốn mức giá cố định</span>
              </div>
            </div>

            {/* Bảng tính giá động (Live Price Calculator) */}
            <div className="cb-price-summary-box">
              ...
              <div className="cb-price-summary-row">
                <span>Giá thuê Áo Dài:</span>
                <span>{aoDaiBasePrice > 0 ? `${aoDaiBasePrice.toLocaleString('vi-VN')}đ` : '—'}</span>
              </div>

              <div className="cb-price-summary-row">
                <span>Giá Gói Chụp Ảnh:</span>
                <span>{pkgBasePrice > 0 ? `${pkgBasePrice.toLocaleString('vi-VN')}đ` : '—'}</span>
              </div>
            ...
            <div className="cb-info-box">
              ...
              <div>
                <strong>Quy tắc tính giá:</strong> Nếu không nhập giá cố định, hệ thống tự động tính theo công thức:{' '}
                <code>(Giá Áo + Giá Gói Chụp) × (1 - % Giảm)</code>.
              </div>
            </div>
          </div>
          ...
          <div className="cb-form-section">
            ...
            <div className="cb-grid-3cols">
              <div className="cb-field-group">
                ...
                />
                <span className="cb-field-hint">Số lượt tối đa bán ra</span>
              </div>
              ...
              <div className="cb-field-group">
                ...
                <span className="cb-field-hint">
                  {selectedPackageMaxPeople !== null
                    ? `Gói tối đa: ${selectedPackageMaxPeople} người`
                    : 'Theo gói chụp'}
                </span>
              </div>
              ...
              <div className="cb-field-group">
                ...
                <span className="cb-field-hint">
                  {selectedProductStock !== null
                    ? `Tồn kho: ${selectedProductStock} bộ`
                    : 'Theo kho'}
                </span>
              </div>
            </div>
