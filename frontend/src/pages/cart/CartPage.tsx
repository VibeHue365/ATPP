            ...
            <aside style={{ position: 'sticky', top: '100px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ backgroundColor: '#FAF5EE', padding: '32px', borderRadius: '16px', border: 'none' }}>
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    backgroundColor: selectedItems.length > 0 ? '#8B1E22' : '#C5B39E',
                    color: 'white',
                    border: 'none',
                    padding: '16px',
                    fontSize: '15px',
                  ...
                  onMouseOver={(e) => {
                    if (selectedItems.length > 0) e.currentTarget.style.backgroundColor = '#72181B';
                  }}
                  onMouseOut={(e) => {
                    if (selectedItems.length > 0) e.currentTarget.style.backgroundColor = '#8B1E22';
                  }}
                >
