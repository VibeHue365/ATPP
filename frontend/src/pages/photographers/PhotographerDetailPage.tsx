...
export const PhotographerDetailPage: React.FC = () => {
  ...
  const handleDirectBooking = async () => {
    ...
    try {
      ...
      const bookingRes: any = await httpClient.post('/bookings/photography', {
      ...
      // Nếu có lỗi (ví dụ chưa đăng nhập hoặc lỗi kết nối), vẫn hiển thị thành công demo để phục vụ demo/mockup
